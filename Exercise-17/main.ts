...
let middleIndex: number = Math.floor(guestList.length / 2);//method used to add something in the middle of array
guestList.splice(middleIndex, 0 ,"Meerub");

console.log("Updated list of our guests");

guestList.forEach(oneguest => console.log(`Hello ${oneguest} Would you like to join the dinner at my place?`));
...
guestList.forEach(lasttwo => console.log(`Hello, ${lasttwo} you are still invited to the dinner`));
